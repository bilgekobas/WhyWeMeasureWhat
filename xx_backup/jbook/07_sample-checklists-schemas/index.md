...
The structure mirrors other established data standards for human studies, such as the Brain Imaging Data Structure (BIDS) \[525\], which separates participants.tsv and sessions.tsv files, and the ISA-Tab framework \[526\], which distinguishes investigation, study, and assay metadata. Our schema follows a similar logic: clean separation of persistent attributes, per-experiment descriptors, and per-visit variables.
