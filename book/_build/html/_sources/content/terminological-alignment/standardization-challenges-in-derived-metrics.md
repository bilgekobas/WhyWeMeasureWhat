...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---|:---:|:---|
|  |  | Forehead | Cheek(l) | Neck(l) | Upper arm(r) | Elbow(l) | Forearm(l) | Palm(l) | Hand(r) | Hand(l) | Back(l) | Chest(l) | Lumber(l) | Abdomen | Buttocks(l) | Thigh(a) | Thigh(l)(p) | Calf(a)(r) | Calf(p)(l) | Foot(l) | Foot(r) | Sole(l) |  |  |  |
...
|  | c |  |   | 0.28 |  |  |  |   | 0.16 |   | 0.28 |  |  |  |  |  |   | 0.28 |  |  |  |  | ?+ | 1992 | {cite:p}`noauthor_iso_2004` |
...
|  | c | 0.10 |  |  |  |   | 0.05 |   | 0.05 |  |   | 0.40 |  |  |   | 0.20 |   | 0.20 |  |  |  |  | Miura et al. | ? | {cite:p}`mochida_tohru_mean_1983` |
...
|  | b |  |  |  |  |   | 0.14 |   | 0.14 |   | 0.07 | 0.07 |  |  |   | 0.14 |  |   | 0.14 | 0.14 |  |  | Park | 1988 | {cite:p}`park_effect_1988` |
...
|  | b | 0.07 |  |   | 0.07 |   | 0.07 |   | 0.05 |   | 0.175 | 0.175 |  |  |   | 0.19 |   | 0.20 |  |  |  |  | Gagge & Nishi + | 1977 | {cite:p}`noauthor_iso_2004,prakash_heat_1977` |
|  | c | 0.21 |  |   | 0.12 |   | 0.06 |  |  |   | 0.11 | 0.10 |   | 0.17 |   | 0.15 |   | 0.08 |  |  |  |  | Nadel  | 1973 | {cite:p}`nadel_differential_1973` |
|  | d | 0.07 |  |   | 0.13 |   | 0.12 |  |  |   | 0.09 | 0.09 |   | 0.18 |   | 0.16 |   | 0.16 |  |  |  |  | Nadel  | 1973 | {cite:p}`nadel_differential_1973` |
|  | e | 0.19 |  |   | 0.13 |   | 0.12 |  |  |   | 0.09 | 0.08 |   | 0.12 |   | 0.12 |   | 0.15 |  |  |  |  | Crawshaw | 1975 | {cite:p}`crawshaw_effect_1975` |
| **9** | a | 0.07 |  |   | 0.07 |   | 0.07 |   | 0.05 |   | 0.18 | 0.18 |  |  |   | 0.19 |   | 0.13 |  |   | 0.06 |  | Ouyang | 1985 | {cite:p}`ouyang_clothes_1985` |
|  | b | 0.12 |  |   | 0.18 |   | 0.05 |   | 0.04 |  |   | 0.18 |   | 0.16 |   | 0.18 |   | 0.11 |  |   | 0.08 |  | Neuroth | ? | {cite:p}`houdas_temperature_1982` |
| **10** | a |   | 0.10 |   | 0.07 |   | 0.07 |   | 0.06 |   | 0.125 | 0.13 |  |  |   | 0.125* |   | 0.15 |  |   | 0.05 |  | Teichner ++ | 1943 | {cite:p}`teichner_assessment_1958` |
|  | b | 0.06 |  |   | 0.09 |   | 0.06 |   | 0.05 |   | 0.19 | 0.10 |   | 0.095 |   | 0.19 |   | 0.12 |  |  |   | 0.06 | Ouyang | 1985 | {cite:p}`ouyang_clothes_1985` |
|  | c | 0.06 |  |   | 0.08 |   | 0.06 |   | 0.05 |   | 0.12 | 0.12 |   | 0.12 |   | 0.19 |   | 0.13 |  |   | 0.07 |  | Colin & Houdas | 1982 | {cite:p}`colin_computation_1971` |
|  | d |   | 0.20 |   | 0.05** |   | 0.05 |  |  |   | 0.20 | 0.05 |   | 0.125(r) |   | 0.125*** |   | 0.075 | 0.075 |  |  |  | Houdas & Ring | 1982 | {cite:p}`colin_computation_1971` |
|  | e |   | 0.10 |   | 0.07 |   | 0.07 |   | 0.06 |   | 0.13 | 0.13 |  |  |   | 0.125** |   | 0.15 |  |   | 0.05 |  | Omrec | ? | {cite:p}`houdas_temperature_1982` |
|  | f | 0.031 |   | 0.043 | 0.082 |   | 0.06 |   | 0.05 |   | 0.17 |  |   | 0.081 | 0.081 | 0.17 |  |   | 0.134 |   | 0.07 |  | Kiurata & Funazu | ? | {cite:p}`mochida_tohru_mean_1983` |
|  | g | 0.10 |  |   | 0.10 |  |  |   | 0.10 |   | 0.10 | 0.10 |   | 0.10 |   | 0.10 | 0.10 |   | 0.10 |   | 0.10 |  | Stolwijk & Hardy | 1966 | {cite:p}`gagge_comfort_1967` |
...
| **17** |   | 0.037 | 0.037 |   | 0.075 |   | 0.075 |   | 0.0250 | 0.0250 | 0.0625 | 0.0625 | 0.0625 | 0.0625 | 0.0625 | 0.0875 | 0.0875 | 0.0875 | 0.0875 | 0.0305 | 0.0305 |  | Ouyang | 1985 | {cite:p}`ouyang_clothes_1985` |
...
|:---|:---:|:---:|:---:|:---:|:---|:---|:---|:---:|
| Burton | 1935 | {math}`T_b = 0.64\,T_{core} + 0.36\,T_{sk}` | 0.64 | 0.36 | Core site not explicitly fixed; later applications typically use rectal temperature | Derived empirically using whole-body calorimetry; assumes relatively homogeneous core tissues and a peripheral temperature gradient from core to skin | Classical thermoregulation studies; early heat-balance models | {cite:p}`burton_human_1935` |
